...
const sendResetPasswordEmail = async (to, token) => {
  ...
  <div style="max-width: 600px; margin: 20px auto; padding: 20px; background-color: #fff; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
    ...
    <p style="color: #666; line-height: 1.6;"><a href="${resetPasswordURL}" style="display: inline-block; padding: 10px 20px; background-color: #213BAA; color: #fff; text-decoration: none; border-radius: 5px;">Reset Password</a></p>
...
<div style="max-width: 600px; margin: 20px auto; padding: 20px; background-color: #fff; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
    ...
    <p style="color: #666; line-height: 1.6;"><a href="${verificationEmailURL}" style="display: inline-block; padding: 10px 20px; background-color: #213BAA; color: #fff; text-decoration: none; border-radius: 5px;">Verify Email</a></p>
